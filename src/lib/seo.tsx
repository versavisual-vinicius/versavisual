...
export const OG_IMAGE =
  "https://images.unsplash.com/photo-1459749411175-04bf5292ceea?auto=format&fit=crop&q=72&w=1200&h=630";
...
export function useSeo({ title, description, path, jsonLd }: Seo) {
  useEffect(() => {
    ...
    upsertMeta('meta[property="og:site_name"]', "property", "og:site_name", "VERSAVISUAL");
