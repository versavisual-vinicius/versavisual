...
export default function Home() {
  ...
  return (
    <>
      ...
      <section
        id="inicio"
        className="relative min-h-screen flex items-end pb-16 md:pb-24 pt-28 overflow-hidden"
      >
        {/* Background Video */}
          ...
          <div className="max-w-3xl space-y-6">
            ...
            <div className="pt-4 flex flex-wrap items-center gap-4">
              <Link
                ...
                viewTransition
                className="px-7 py-3.5 rounded-full text-base font-head font-semibold bg-teal text-off hover:bg-teal-400 transition shadow-xl shadow-teal/20"
              >
                Iniciar projeto
              </Link>
              <Link
                to="/portfolio"
                viewTransition
                className="px-6 py-3.5 rounded-full text-base font-head font-medium text-off hover:text-white bg-navy/60 hover:bg-navy/90 border border-navy transition flex items-center gap-2"
              >
      ...
      <section className="relative bg-ink py-24 md:py-32 border-t border-navy/30">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="mt-16 pt-10 border-t border-navy/60 grid grid-cols-2 md:grid-cols-4 gap-8">
            <div>
              <p className="font-head font-extrabold text-4xl sm:text-5xl text-off tracking-tight">
                +120
              </p>
        ...
        <div className="max-w-7xl mx-auto px-6 space-y-16">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            <p className="font-body text-sm md:text-base text-mist max-w-md text-pretty">
              Ativações, grandes palcos, campanhas de moda e videoclipes com
          ...
          <div className="space-y-8">
            ...
            <Link
              to="/portfolio/carnaval-de-rua-experiencia-publico"
              className="block group relative rounded-2xl overflow-hidden bg-navy/20 border border-navy/40 transition duration-500 hover:border-teal/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal"
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-ink/90 via-ink/20 to-transparent flex items-end p-6 md:p-10">
                <div>
                  <p className="font-head text-xs uppercase tracking-widest text-teal-400 font-semibold">
                    Grandes Palcos & Ativação
                  </p>
                  <h3 className="font-head font-bold text-xl md:text-3xl text-off mt-1">
                    Megabloco Chá da Alice
                  </h3>
                  <p className="font-body text-sm text-mist mt-1">
                    Rio de Janeiro · Babado Novo & Christian Chávez
                  </p>
                </div>
              </div>
            </Link>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Link
                to="/portfolio/e-o-tchan-jogadinha"
                className="block md:col-span-2 group relative rounded-2xl overflow-hidden bg-navy/20 border border-navy/40 transition duration-500 hover:border-teal/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal"
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-ink/90 via-ink/20 to-transparent flex items-end p-6 md:p-8">
                  <div>
                    ...
                    <h3 className="font-head font-bold text-xl md:text-2xl text-off mt-1">
                      É O Tchan — Clipe Jogadinha
                    </h3>
                    <p className="font-body text-sm text-mist mt-1">
                      Direção de cena e cobertura audiovisual
                    </p>
                  </div>
                </div>
              </Link>
              ...
              <Link
                to="/portfolio/fashion-week-passarela-bastidor"
                className="block md:col-span-1 group relative rounded-2xl overflow-hidden bg-navy/20 border border-navy/40 transition duration-500 hover:border-teal/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal"
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-ink/90 via-ink/20 to-transparent flex items-end p-6 md:p-8">
                  <div>
                    ...
                    <h3 className="font-head font-bold text-xl text-off mt-1">
                      Fashion Manners
                    </h3>
                    <p className="font-body text-sm text-mist mt-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Link
                to="/portfolio/ativacao-drinkball"
                className="block md:col-span-1 group relative rounded-2xl overflow-hidden bg-navy/20 border border-navy/40 transition duration-500 hover:border-teal/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal"
              >
                <div className="aspect-[16/10] md:aspect-[3/4] w-full overflow-hidden">
                  <img
              ...
              <Link
                to="/portfolio/camarote-ondina-salvador"
                className="block md:col-span-2 group relative rounded-2xl overflow-hidden bg-navy/20 border border-navy/40 transition duration-500 hover:border-teal/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal"
              >
                <div className="aspect-[16/10] w-full overflow-hidden">
                  <img
      ...
      <section id="case" className="py-24 bg-ink border-t border-navy/30">
        <div className="max-w-7xl mx-auto px-6">
          <div className="rounded-3xl p-8 md:p-14 border border-navy/50 case-gradient relative overflow-hidden group transition duration-500 hover:border-teal/50">
            ...
            <Link
              to="/portfolio/babado-novo-sururu"
              className="absolute inset-0 z-10 focus-visible:outline-none focus-visible:ring-inset focus-visible:ring-2 focus-visible:ring-teal"
              aria-label="Ver case completo Babado Novo - Clipe Sururu"
            ></Link>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-0">
              <div className="lg:col-span-6 space-y-8">
                ...
                <div className="space-y-4 pt-2 border-t border-navy/60">
                  <div>
                    <p className="font-head text-xs uppercase tracking-wider text-teal-400 font-semibold">
                      Pedido
                    </p>
                    <p className="font-body text-sm md:text-base text-off mt-0.5 text-pretty">
                      Direção de imagem para clipe e backstage.
                    </p>
                  </div>
                  <div>
                    <p className="font-head text-xs uppercase tracking-wider text-teal-400 font-semibold">
                    ...
                    <p className="font-body text-sm md:text-base text-off mt-0.5 text-pretty">
                      Artista em set. Palco, luz de alta pressão e estúdio.
                    </p>
                  </div>
                  <div>
                    <p className="font-head text-xs uppercase tracking-wider text-teal-400 font-semibold">
                    ...
                    <p className="font-body text-sm md:text-base text-off mt-0.5 text-pretty">
                      Fotografia · Vídeo · Direção de cena em tempo real.
                    </p>
                  </div>
                  <div>
                    <p className="font-head text-xs uppercase tracking-wider text-teal-400 font-semibold">
                    ...
                    <p className="font-body text-sm md:text-base text-off mt-0.5 text-pretty">
                      A imagem que o trabalho e a turnê passam a usar depois.
                    </p>
                  </div>
                </div>
                ...
                <div className="pt-4 relative z-20">
                  <Link
                    to="/diagnostico-visual"
                    className="inline-flex items-center gap-2 font-head text-sm font-semibold text-teal-400 hover:text-off transition"
                  >
        ...
        <div className="max-w-7xl mx-auto px-6 space-y-24">
          <div className="space-y-6">
            ...
            <div className="pt-6 border-t border-navy/60 grid grid-cols-1 md:grid-cols-3 gap-8">
              <div>
                <h3 className="font-head font-bold text-2xl text-off">
                  01. Direção visual
                </h3>
                <p className="font-body text-sm text-mist mt-2 leading-relaxed text-pretty">
                  Conceituação de cena, paleta de cor, moodboard e
                  posicionamento de marca antes de ligar a câmera.
                </p>
              </div>
              <div>
                <h3 className="font-head font-bold text-2xl text-off">
                ...
                <p className="font-body text-sm text-mist mt-2 leading-relaxed text-pretty">
                  Operação em grandes eventos, palcos, sets de clipe e campanhas
                  com agilidade e alta precisão técnica.
                </p>
              </div>
              <div>
                <h3 className="font-head font-bold text-2xl text-off">
                ...
                <p className="font-body text-sm text-mist mt-2 leading-relaxed text-pretty">
                  Tratamento de cor cinematográfico, finalização editorial e
                  entrega estruturada para múltiplos canais.
                </p>
              </div>
            </div>
          </div>
          ...
          <Link
            to="/sobre"
            className="block p-8 md:p-12 rounded-3xl bg-navy/20 border border-navy/40 transition duration-500 hover:border-teal/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal group"
          >
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 items-center">
              ...
              <div className="md:col-span-7 space-y-6">
                <div>
                  ...
                  <h3 className="font-head font-extrabold text-3xl sm:text-4xl text-off mt-1">
                    Vinicius Cunha
                  </h3>
                  <p className="font-body text-sm text-mist">
                    Fundador e diretor de cena · Rio de Janeiro · operação
                    nacional
                  </p>
                </div>

                <p className="font-body text-base text-off/90 leading-relaxed text-pretty">
                  Fundador da VERSAVISUAL. Une direção visual cinematográfica à
                  disciplina rigorosa de produção. Atuação em campanhas
                  nacionais, videoclipes de grandes artistas e eventos com
                  público massivo.
                </p>
                ...
                <div className="pt-4 border-t border-navy/60 flex items-center gap-8">
                  <div>
                    <p className="font-head font-extrabold text-2xl text-off">
                      +120
                    </p>
      ...
      <section
        id="contato"
        className="relative py-28 md:py-36 bg-ink border-t border-navy/40 overflow-hidden"
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center space-y-8">
          ...
          <p className="font-body text-base sm:text-lg text-mist max-w-xl mx-auto leading-relaxed text-pretty">
            Direção de imagem para marcas, eventos e artistas com cronograma
            estruturado e resposta rápida.
          </p>
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/diagnostico-visual"
              viewTransition
              className="w-full sm:w-auto px-8 py-4 rounded-full text-base font-head font-semibold bg-teal text-off hover:bg-teal-400 transition shadow-2xl shadow-teal/30"
            >
              Iniciar projeto
            </Link>
            <a
              href="https://wa.me/5522997624631"
              target="_blank"
              rel="noreferrer"
              className="w-full sm:w-auto px-8 py-4 rounded-full text-base font-head font-medium text-off bg-navy/60 hover:bg-navy/90 border border-navy transition flex items-center justify-center gap-2"
            >
