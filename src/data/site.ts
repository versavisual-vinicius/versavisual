...
export const PORTFOLIO: PortfolioItem[] = [
  ...
  {
    category: "Moda & Campanhas",
    title: "Loja Frida — Campanha de Moda Feminina",
    city: "Rio de Janeiro · RJ",
    photo: LOJA_FRIDA_PHOTOS[0] || P.fashion[2],
    caseSlug: "loja-frida-campanha",
    segmentSlug: "moda-campanhas",
  ...
  },
  {
    ...
    photo: BACKSTAGE_CLIPE_SURURU_PHOTOS[0] || P.artists[0],
  ...
  },
  {
    ...
    city: "Rio de Janeiro · RJ",
    photo: MEGABLOCO_CHA_DA_ALICE_PHOTOS[10] || P.artists[1],
  ...
  {
    category: "Posicionamento Profissional",
    title: "Retratos Urbanos Street — Posicionamento e Presença",
    city: "Rio de Janeiro · RJ",
  ...
  {
    category: "Imagem Pessoal & Lifestyle",
    title: "Ensaio Feminino — Frida",
    city: "Rio de Janeiro · RJ",
    photo: LOJA_FRIDA_PHOTOS[1] || P.personal[1],
    caseSlug: "ensaio-feminino-frida",
    segmentSlug: "imagem-pessoal-lifestyle",
    gallery: LOJA_FRIDA_PHOTOS,
  },
  {
  ...
  {
    category: "Gestantes",
    title: "Ensaio Gestante — Intimidade e Presença",
    city: "Macaé · RJ",
    photo: P.maternity[1],
    segmentSlug: "gestantes",
    gallery: P.maternity,
