...
export default function PrivacyModal({ isOpen, onClose }: PrivacyModalProps) {
  ...
  return (
    <dialog
      ...
      onCancel={onClose}
      onClose={onClose}
      className="m-auto max-h-[90vh] w-[calc(100%-2rem)] max-w-2xl overflow-y-auto rounded-2xl border border-line bg-off p-6 text-ink shadow-2xl backdrop:bg-ink/80 backdrop:backdrop-blur-sm sm:p-8 scrollbar-thin"
    >
      <button
        type="button"
        onClick={onClose}
      ...
      <div className="mt-6 space-y-5 text-sm leading-relaxed text-navy border-t border-line pt-5">
        <section>
          ...
          <p className="mt-1.5">
            ...
            controladora dos dados pessoais coletados por este website, em total
            conformidade com a{" "}
            <strong>
        ...
        <section>
          ...
          <ul className="mt-2 space-y-2 list-none">
            <li className="flex items-start gap-2">
              ...
              <span>
                <strong>Formulário de Diagnóstico Visual:</strong> Nome, e-mail,
                telefone/WhatsApp, empresa, cidade, nicho de atuação e detalhes
                do projeto. Finalidade: elaboração de proposta técnica sob
                medida, retorno de contato e planejamento audiovisual.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <CheckCircle2 className="h-4 w-4 shrink-0 text-teal mt-0.5" />
              <span>
                ...
                tráfego (Vercel Analytics) para melhoria de desempenho, tempo de
                resposta e usabilidade, sem cruzamento com dados pessoais
                identificáveis.
              </span>
            </li>
          </ul>
        ...
        <section>
          ...
          <p className="mt-1.5">
            ...
            <strong>procedimentos preliminares relacionados a contrato</strong>{" "}
        ...
        <section>
          <h3 className="font-semibold text-ink flex items-center gap-2 text-base">
            <Mail className="h-4 w-4 text-teal" /> 4. Seus Direitos (Art. 18 da
            LGPD) e Canal de Contato
          </h3>
          <p className="mt-1.5">
